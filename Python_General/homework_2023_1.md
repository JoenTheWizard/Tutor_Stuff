...
An example output from the program (**Note: Its better off not showing the output from your program to anyone else, just show the code. This task just requires you to explain what these headers mean and understanding HTTP requests and responses using Python**):
```http
